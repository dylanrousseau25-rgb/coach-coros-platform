const CACHE='coach-coros-v4-14-plan-timeout';
const SHELL=['/','/index.html','/styles.css','/app.js','/runtime-fixes.js','/freshness-guard.js','/coros-runtime.js','/coach-polish.js','/plan-continuity.js','/plan-v2-runtime.js','/plan-v3-runtime.js','/manifest.webmanifest'];
